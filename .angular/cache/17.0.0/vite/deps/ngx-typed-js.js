...
NgxTypedJsComponent.ɵfac = function NgxTypedJsComponent_Factory(t2) {
  return new (t2 || NgxTypedJsComponent)();
};
...
NgxTypedJsModule.ɵfac = function NgxTypedJsModule_Factory(t2) {
  return new (t2 || NgxTypedJsModule)();
};
